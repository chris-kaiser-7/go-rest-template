...
// UserDataAccess struct wraps a sql.DB connection pool and allows us to work with the User struct type
...
func (m UserDataAccess) Insert(user *User) error {
	query := `
...
func (m UserDataAccess) GetByEmail(email string) (*User, error) {
	query := `
...
func (m UserDataAccess) Update(user *User) error {
	query := `
		UPDATE users
...
func (m UserDataAccess) GetForToken(tokenScope, tokenPlaintext string) (*User, error) {
